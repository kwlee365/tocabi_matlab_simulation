...
Impact_duration = 0.1;          % [s] : Impact duration
Impact_timing = 0.0;            % [s] : Timing of impact
Impact_step_number = 4;        

% Simulation flags
flag_HORIZON_CHANGED = 0;
...
p_ref_total = zmpTotal(number_of_step, step_length, step_width, L_or_R);    % TODO : Add Double Support Phase
...
flag_PAUSE = 0;
flag_ERROR = 0;
% Preview control  *TODO : Preview control -> MPC
...
while 1
    ...
    if flag_VISUALIZATION == 1
        ...
        set(axe,'XLim',[-0.5+COM(1) 0.5+COM(1)],'YLim',[-0.5+COM(2) 0.5+COM(2)],'ZLim',[-0.02 1.2], 'DataAspectRatio', [1 1 1]);
    end
