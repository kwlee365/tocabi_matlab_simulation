function [COM_next, dCOM_next, ddCOM_next, p_err_sum_x_next, p_err_sum_y_next] = previewControlMPC(t_step, step_phase, p_total, T_step_total, Gi, Gx, Gp, A, B, C, COM, dCOM, ddCOM, p_err_sum_x, p_err_sum_y)
