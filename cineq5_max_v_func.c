...
/* cineq5_max_v_func:(i0[180],i1)->(o0[30x360,60nz]) */
...
void mex_cineq5_max_v_func(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  casadi_real* res[1] = {0};
  if (argc>2) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"cineq5_max_v_func\" failed. Too many input arguments (%d, max 2)", argc);
  ...
  --resc;
  res[0] = w+181;
  i = cineq5_max_v_func(arg, res, iw, w+241, 0);
...
casadi_int main_cineq5_max_v_func(casadi_int argc, char* argv[]) {
  ...
  flag = cineq5_max_v_func(arg, res, iw, w+241, 0);
  if (flag) return flag;
  r = w+181;
