...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %--- TOCABI 
        % mass of each link * TODO: Add Upper body mass and kinematic information
        m_PEL = 12.19525;
        m_TORSO = 42.0301;
        m_LHY = 2.679;
        m_LHR = 2.67;
        ...
        m_RAR = 1.26426;
        m_RF = 2.326;
        m_all = PARA.m_PEL + PARA.m_TORSO + (PARA.m_LHY+PARA.m_LHR+PARA.m_LHP+PARA.m_LKN+PARA.m_LAP+PARA.m_LAR+PARA.m_LF) + (PARA.m_RHY+PARA.m_RHR+PARA.m_RHP+PARA.m_RKN+PARA.m_RAP+PARA.m_RAR+PARA.m_RF);
        
        % link length
        l0 = 0.2;      % Torso -> Pelvis
        l1 = 0.1025;   % Pelvis -> Hip yaw
        l2 = 0.01;     % Hip yaw -> Hip roll
        l3 = 0.01;     % Hip roll -> Hip pitch
