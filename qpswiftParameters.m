...
X_ref = zeros(H*state_length,1);  % Why X_ref is not the xi_ref_horizon?
U = v(H*state_length+1:end, 1);

% Cost function
c = J_v_func(gain_state_horizon, gain_input_horizon, X, X_ref, U);  % Gradient
P = J_vv_func(gain_state_horizon, gain_input_horizon, X, X_ref, U); % Hessian
