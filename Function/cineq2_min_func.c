...
/* cineq2_min_func:(i0[180],i1)->(o0[30]) */
...
void mex_cineq2_min_func(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  casadi_real* res[1] = {0};
  if (argc>2) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"cineq2_min_func\" failed. Too many input arguments (%d, max 2)", argc);
  ...
  --resc;
  res[0] = w+181;
  i = cineq2_min_func(arg, res, iw, w+211, 0);
...
casadi_int main_cineq2_min_func(casadi_int argc, char* argv[]) {
  ...
  flag = cineq2_min_func(arg, res, iw, w+211, 0);
  if (flag) return flag;
  r = w+181;
